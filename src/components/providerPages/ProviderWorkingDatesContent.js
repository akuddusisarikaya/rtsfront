...
export default function ProviderWorkingDatesContent() {
    ...
    const fetchAppointments = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `http://54.93.232.137:8080/provider/getappointments?email=${user.email}&date=${formattedDate}`,
          {
            method: "GET",
            headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        "http://54.93.232.137:8080/provider/addproviderapp",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleAuto = async () => {
    ...
    try {
      const response = await fetch(
        "http://54.93.232.137:8080/provider/addappauto",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(
        `http://54.93.232.137:8080/provider/deleteapp?id=${id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
